//
//  MavericardRootController.swift
//  MavericardDeceptex
//
...
class MavericardRootController: UIViewController {
    ...
    private func loadAdsDataIfNeeded() {
        ...
        guard mavericardNeedLoadAdBannData() else { return }
    ...
    private func postAppDeviceData() {
        ...
        let hostUrl = mavericardMainHostUrl()
        let endpoint = "https://open.ma\(hostUrl)/open/mavericardPostAppDeviceData"
        ...
        let parameters: [String: Any] = [
            "appKey": "4040ddec84714dc1b8f7b935143776bc",
    ...
    private func handlePostResponse(data: Data?, error: Error?) {
        ...
        do {
            ...
            mavericardShowAdVsiew(adsData[0])
        } catch {
